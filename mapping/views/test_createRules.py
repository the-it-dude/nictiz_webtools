...
from mapping.models import MappingCodesystemComponent, MappingEclPart, MappingRule
...
class optimizedCreateRules(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None):
        print(
            f"[test_createRules/optimizedCreateRules retrieve] requested @ {time.strftime('%c')} with pk {pk}"
        )
        try:
            error = False
            output = True
