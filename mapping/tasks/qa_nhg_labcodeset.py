...
def nhg_loinc_order_vs_observation(taskid):
    ...
    for mapping in mappings:
        ...
        if (
            mapping.source_component.codesystem_id.codesystem_title == "Labcodeset"
        ) and (
            mapping.target_component.codesystem_id.codesystem_title
            == "NHG Diagnostische bepalingen"
        ):
        ...
        if (
            (
                mapping.source_component.codesystem_id.codesystem_title
                == "NHG Diagnostische bepalingen"
            )
            and (
                mapping.target_component.codesystem_id.codesystem_title == "Labcodeset"
            )
        ) or (
            (
                mapping.target_component.codesystem_id.codesystem_title
            ...
            if (source == "A" and target == "Observation") or (
                target == "A" and source == "Observation"
            ):
                hit = True
            if (source == "U" and target == "Order") or (
                target == "U" and source == "Order"
            ):
                hit = True
